...
public class RotatorJ extends RotatorStrategy {

    public RotatorJ(GameField gameField, FormJ form) {
    ...
    public void rotate() {
        ...
        switch(form.getFormRotationLevel()){
            case(1):
                ...
                if (checkNextPosition(form.getFormRect(Form.RectEnum.a), 1, 0) && checkNextPosition(form.getFormRect(Form.RectEnum.d), -1, -2)){
            ...
            case(2):
                if (checkNextPosition(form.getFormRect(Form.RectEnum.a), 1, -1) && checkNextPosition(form.getFormRect(Form.RectEnum.b), 2, 0)) {
                    MoveRight(form.getFormRect(Form.RectEnum.a));
            ...
            case(3):
                if (checkNextPosition(form.getFormRect(Form.RectEnum.a), -1, -1 ) && checkNextPosition(form.getFormRect(Form.RectEnum.b), 0, -2)) {
                    MoveUp(form.getFormRect(Form.RectEnum.a));
            ...
            case(4):
                if (checkNextPosition(form.getFormRect(Form.RectEnum.a), -1, 2) && checkNextPosition(form.getFormRect(Form.RectEnum.b), -2, 1) && checkNextPosition(form.getFormRect(Form.RectEnum.c), -1, 0)) {
